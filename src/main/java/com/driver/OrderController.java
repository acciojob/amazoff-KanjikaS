...
public class OrderController {
    ...
    public ResponseEntity<Order> getOrderById(@PathVariable String orderId){
        ...
        Order order = orderService.getOrderById(orderId);         //order should be returned with an orderId.
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount =  orderService != null ? orderService.getOrderCountByPartnerId(partnerId) : 0;;
    ...
    public ResponseEntity<List<String>> getAllOrders(){
        List<String> orders = orderService.getAllOrders();        //Get all orders
        return new ResponseEntity<>(orders, HttpStatus.CREATED);
    }

    @GetMapping("/get-count-of-unassigned-orders")
    public ResponseEntity<Integer> getCountOfUnassignedOrders(){
        Integer countOfOrders = orderService != null ? orderService.getCountOfUnassignedOrders():0;
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId) {
        try {
            ...
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);  // 400 if invalid time format
        }
    }
